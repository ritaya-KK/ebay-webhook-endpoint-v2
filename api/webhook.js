    ...
    module.exports = async (req, res) => {
      ...
      if (req.method === 'GET') {
        ...
        if (!challengeCode) {
          console.log('Challenge code is missing. Responding 200 OK to acknowledge endpoint is live.');
          res.status(200).send('Endpoint is live. Challenge code not provided.');
          return;
        }
